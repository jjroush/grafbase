...
impl<'ctx> ShapesBuilder<'ctx> {
    ...
    fn create_concrete_shape(
        ...
        typename_fields_sorted_by_response_key_str_then_position: &[PartitionTypenameField<'ctx>],
        data_fields_sorted_by_response_key_str_then_position: &[PartitionDataField<'ctx>],
